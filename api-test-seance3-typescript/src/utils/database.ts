...
export const users: User[] = [
  {
    id: 1,
    email: 'admin@cnss.bj',
    password: '$2a$10$XQxBtM1ixHG5HJT9C1L1/.4Iq5W9cNWJR5l3UqMVgqKCyoQJkVDSe',
    name: 'Administrateur CNSS',
    role: 'admin',
    avatar: 'https://ui-avatars.com/api/?name=Admin+CNSS&background=0D8ABC&color=fff',
  ...
  },
  {
    ...
    role: 'user',
    avatar: 'https://ui-avatars.com/api/?name=User+Test&background=4ADE80&color=fff',
  ...
  },
  {
    ...
    role: 'developer',
    avatar: 'https://ui-avatars.com/api/?name=Dev+Frontend&background=61DAFB&color=000',
